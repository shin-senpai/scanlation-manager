-- 025_add_todo_sheet_view.sql
-- days_active is measured from when the task actually became actionable:
--   - No prerequisites              → days since assigned_at
--   - All prerequisites completed   → days since GREATEST(assigned_at, latest prereq completion)
--   - Any prerequisite still open   → 0 (task is blocked, not yet workable)
